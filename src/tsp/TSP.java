...
public class TSP {
    ...
    public static final int genCount = 15000;
    ...
    //public ArrayList<City> list = new ArrayList<City>(Arrays.asList(new City("AL",32.361538,-86.279118), new City("AK",58.301935,-134.419740), new City("AZ",33.448457,-112.073844), new City("AR",34.736009,-92.331122)));
    ...
    public static void main(String[] args) {
        ...
        int bestRouteGen = 1;       
        tsp.drawRoute(bestRoute);
        for(int i = 1;i<=genCount;i++){
            
            System.out.println("Generation "+ i +" Populations");
            pop.sortRouteList();   
    ...
    public void result(Routes br, int brg){
        System.out.println("\nBest Route from Generation " + brg); 
    ...
    private void drawRoute(Routes br) {
        ...
        JFrame frame = new JFrame("Best route found");
